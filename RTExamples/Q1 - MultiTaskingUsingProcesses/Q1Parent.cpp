...
//		ACTIVE or SUSPENDED. Default is ACTIVE if not specifie
	...
	CProcess p1("C:\\RTExamples\\Q1 - MultiTaskingUsingProcesses\\Q1Child1\\debug\\Q1Child1.exe",	// pathlist to child program executable				
	...
	CProcess p2("C:\\RTExamples\\Q1 - MultiTaskingUsingProcesses\\Q1Child2\\debug\\Q1Child2.exe",	// pathlist to child program executable				
			NORMAL_PRIORITY_CLASS,			// priority
			OWN_WINDOW,						// process has its own window					
			ACTIVE							// process is active immediately
	) ;

	CProcess p3("C:\\RTExamples\\Q1 - MultiTaskingUsingProcesses\\Q1Child3\\debug\\Q1Child3.exe fred 1.2",	// pathlist to child program executable	plus some arguments		
			NORMAL_PRIORITY_CLASS,			// priority
			OWN_WINDOW,						// process has its own window					
			ACTIVE
	);
