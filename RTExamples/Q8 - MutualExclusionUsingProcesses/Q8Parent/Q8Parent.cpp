...
int main()
{
	...
	CProcess p1(					// create a child process
		"C:\\RTExamples\\Q8 - MutualExclusionUsingProcesses\\debug\\Q8Child.exe",
	...
	for (unsigned long long int i = 0; i < 400000000ULL; i++) 		// access resource note REDUCE SIZE OF LOOP WHEN USING MUTEX OTHERWISE IT TAKES FOREVER
	{
		a = DataPtr->x;
		a = a + 1;
